...
import { Send, MapPin, Layers } from 'lucide-react';
import { Panel, StatCard, Badge, Btn, LEVEL_COLOR } from '@/components/UI';
...
export default function AlertsPage({ events }: { events: SeismicEvent[] }) {
