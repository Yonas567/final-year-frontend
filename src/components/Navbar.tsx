...
const NAV_ITEMS = [
  ...
  { id: "samples", label: "Sensor Data", Icon: Table2, href: "/samples" },
  { id: "import", label: "Import", Icon: FileSpreadsheet, href: "/import" },
  { id: "prediction", label: "Predictions", Icon: BarChart2, href: "/prediction" },
